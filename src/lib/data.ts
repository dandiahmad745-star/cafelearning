import type { Coffee, Guide, BlogPost, Review } from './types';

export const reviews: Review[] = [
    { id: 'rev1', author: 'Alice', rating: 5, comment: 'Absolutely divine! The fruity notes are so clear.', date: '2023-10-26' },
    { id: 'rev2', author: 'Bob', rating: 4, comment: 'A very solid coffee, great for my morning pour-over.', date: '2023-10-25' },
    { id: 'rev3', author: 'Charlie', rating: 5, comment: 'Rich and complex. Will buy again!', date: '2023-09-15' },
    { id: 'rev4', author: 'Diana', rating: 3, comment: 'It was good, but not my favorite. A bit too acidic for my taste.', date: '2023-09-10' },
];
