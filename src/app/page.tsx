      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] text-primary-foreground">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
          ...
          <p className="text-lg md:text-2xl max-w-3xl mb-8 drop-shadow-md">
            Browse our collection of single-origin beans and master the art of brewing.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-6">
                Whether you're a beginner or a seasoned barista, our guides will help you unlock the full potential of your coffee.
              </p>
